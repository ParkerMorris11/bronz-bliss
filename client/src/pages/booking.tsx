      ...
      <div className="bg-white dark:bg-stone-900 border-b">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-2.5">
          ...
          <div>
            ...
            {settings?.address && (
              <p className="text-[10px] text-muted-foreground leading-tight mt-0.5">{settings.address}</p>
            )}
          </div>
        </div>
      </div>
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">{selectedService.name} · {selectedService.duration} min · ${selectedService.price}</p>
              </div>
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-lg py-1.5 text-xs font-medium transition-colors ${
                        ...
                        isPast || !isThisMonth ? "text-muted-foreground/40 cursor-default" :
            ...
            <div>
              ...
              {!availability ? (
                ...
                <div className="rounded-xl border border-dashed p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Closed on this day</p>
                </div>
        ...
        {step === "info" && (
          <div className="space-y-5">
            ...
            <div className="rounded-xl bg-primary/5 border border-primary/20 p-4 space-y-1.5">
              <p className="text-xs font-semibold uppercase tracking-wide text-primary/70">Booking Summary</p>
        ...
        {step === "done" && confirmation && (
          <div className="text-center py-8 space-y-4">
            ...
            <div className="rounded-xl bg-white dark:bg-stone-900 border p-4 text-left space-y-2 max-w-xs mx-auto">
              ...
              <p className="text-sm text-muted-foreground">{formatTime(confirmation.time)}</p>
              {settings?.depositRequired && settings.depositAmount && (
